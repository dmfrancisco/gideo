...
!function(){if(!window.gideoIncluded){window.gideoIncluded=!0;var e={listen:function(e,o,i){o.addEventListener?o.addEventListener(e,i,!1):o.attachEvent&&o.attachEvent("on"+e,i)},isVisible:function(e){var o=e.getBoundingClientRect();return o.top>-e.offsetHeight&&o.top<(window.innerHeight||document.documentElement.clientHeight)},injectStyles:function(e){var o=document.createElement("div");o.innerHTML="&shy;<style>"+e+"</style>",document.body.appendChild(o.childNodes[1])},isMobile:function(){return navigator.userAgent.match(/(Android|iPod|iPhone|iPad)/)}};window.gideoRoot=window.gideoRoot||"//dmfrancisco.github.io/gideo/",window.gideoMode=window.gideoMode||(e.isMobile()?"manual":"autoplayer");var o=function(){window.setInterval(function(){for(var o,i=document.querySelectorAll(".gideo"),t=0;t<i.length;t++)if(o=i[t].player)if(e.isVisible(i[t].parentNode)){if(o.paused()){try{o.currentTime(0)}catch(n){}o.play()}}else o.paused()||o.pause()},1e3),e.listen("click",document.querySelector("body"),function(e){var o,i=e.target||e.srcElement;if("gideo-mute"===i.className){if(o=i.parentNode.querySelector(".gideo").player,!o)return;o.muted()?(o.currentTime(0),o.muted(!1),i.style.backgroundPosition="0 -36px"):(o.muted(!0),i.style.backgroundPosition="0 0")}else"gideo-replay"===i.className&&(o=i.parentNode.querySelector(".gideo").player,o&&o.currentTime(0))}),e.injectStyles(" .gideo-mute, .gideo-replay { position: absolute; z-index: 2; width: 44px; height: 36px; left: 20px; background: url("+window.gideoRoot+"sprites.png); cursor: pointer } .gideo-mute { top: 20px } .gideo-replay { bottom: 20px; background-position: 0 -72px }")},i=function(){window.setInterval(function(){for(var o,i=document.querySelectorAll(".gideo"),t=0;t<i.length;t++)o=i[t].player,o&&!e.isVisible(i[t].parentNode)&&o.pause()},1e3)};switch(gideoMode){case"autoplayer":o();break;case"manual":i()}videojs.options.flash.swf=window.gideoRoot+"video-js.swf",e.injectStyles(" .gideo .vjs-big-play-button { position: absolute; z-index: 2; width: 68px; height: 68px; top: 50%; left: 50%; margin: -34px auto auto -34px; background: url("+window.gideoRoot+"sprites.png) -44px 0 } .gideo.vjs-playing .vjs-big-play-button { display: none }")}var t=function(){"autoplayer"===window.gideoMode&&this.muted(!0)};window.gideoInit=window.gideoInit||function(e,o){videojs(e).ready(o)};for(var n=document.querySelectorAll(".gideo"),d=0;d<n.length;d++)n[d].player||window.gideoInit(n[d],t)}();