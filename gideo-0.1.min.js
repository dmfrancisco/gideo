...
!function(){var e=function(){return navigator.userAgent.match(/(Android|iPod|iPhone|iPad)/)};if(!window.GIDEO){window.GIDEO=!0,window.gideoRoot=window.gideoRoot||document.location.protocol+"//dmfrancisco.github.io/gideo/",videojs.options.flash.swf=window.gideoRoot+"video-js.swf";var o=function(e,o,t){o.addEventListener?o.addEventListener(e,t,!1):o.attachEvent&&o.attachEvent("on"+e,t)},t=function(e){var o=e.getBoundingClientRect();return o.top>-e.offsetHeight&&o.top<(window.innerHeight||document.documentElement.clientHeight)},i=function(e){var o=document.createElement("div");o.innerHTML="&shy;<style>"+e+"</style>",document.body.appendChild(o.childNodes[1])};e()?window.setInterval(function(){for(var e,o=document.querySelectorAll(".gideo"),i=0;i<o.length;i++)e=o[i].player,e&&!t(o[i])&&e.pause()},1e3):(window.setInterval(function(){for(var e,o=document.querySelectorAll(".gideo"),i=0;i<o.length;i++)if(e=o[i].player)if(t(o[i])){if(e.paused()){try{e.currentTime(0)}catch(n){}e.play()}}else e.paused()||e.pause()},1e3),o("click",document.querySelector("body"),function(e){var o,t=e.target||e.srcElement;if("gideo-mute"===t.className){if(o=t.nextSibling.player,!o)return;o.muted()?(o.currentTime(0),o.muted(!1),t.style.backgroundPosition="0 -36px"):(o.muted(!0),t.style.backgroundPosition="0 0")}else"gideo-replay"===t.className&&(o=t.previousSibling.player,o&&o.currentTime(0))}),i(" .gideo-mute, .gideo-replay { position: absolute; z-index: 2; width: 44px; height: 36px; left: 20px; background: url("+window.gideoRoot+"sprites.png); cursor: pointer } .gideo-mute { top: 20px } .gideo-replay { bottom: 20px; background-position: 0 -72px }")),i(" .gideo .vjs-big-play-button { position: absolute; z-index: 2; width: 68px; height: 68px; top: 50%; left: 50%; margin: -34px auto auto -34px; background: url("+window.gideoRoot+"sprites.png) -44px 0 } .gideo.vjs-playing .vjs-big-play-button { display: none }")}for(var n=document.querySelectorAll(".gideo"),d=function(){this.muted(!e())},r=0;r<n.length;r++)n[r].player||videojs(n[r]).ready(d)}();