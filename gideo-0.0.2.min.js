...
!function(){function e(){return!navigator.userAgent.match(/(iPod|iPhone|iPad)/)}function t(e,t,o){t.addEventListener?t.addEventListener(e,o,!1):t.attachEvent&&t.attachEvent("on"+e,o)}function o(e){var t=e.getBoundingClientRect();return t.top>-e.offsetHeight&&t.top<(window.innerHeight||document.documentElement.clientHeight)}window.gideoRoot=window.gideoRoot||document.location.protocol+"//dmfrancisco.github.io/gideo/",videojs.options.flash.swf=window.gideoRoot+"video-js.swf",!window.GIDEO&&e()&&(window.GIDEO=!0,window.setInterval(function(){for(var e=document.querySelectorAll(".gideo"),t=0;t<e.length;t++){var n=e[t].player;if(n)if(o(e[t])){if(n.paused()){try{n.currentTime(0)}catch(i){}n.play()}}else n.paused()||n.pause()}},100),t("click",document.querySelector("body"),function(e){if("gideo-mute"===e.target.className){var t=e.target.nextSibling.player;if(!t)return;if(t.muted()){try{t.currentTime(0)}catch(e){}t.muted(!1),e.target.style.background="url('"+window.gideoRoot+"on.png')"}else t.muted(!0),e.target.style.background="url('"+window.gideoRoot+"off.png')"}}));for(var n=document.querySelectorAll(".gideo"),i=function(){this.muted(e())},d=0;d<n.length;d++)n[d].player||videojs(n[d]).ready(i)}();